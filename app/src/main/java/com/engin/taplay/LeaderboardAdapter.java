...
public class LeaderboardAdapter extends RecyclerView.Adapter<LeaderboardAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull LeaderboardAdapter.MyViewHolder holder, int position) {
        ...
        if (scoresBuffer.get(position).getScoreOwnerIconUri() != null) {
            ...
            holder.userImg.setImageResource(R.drawable.math_pp);
        }
        ...
        buffer.append("Score: ").append(displayScore).append("\n");
        ...
        buffer.append("Username: ").append(playerDisplayName).append("\n");
